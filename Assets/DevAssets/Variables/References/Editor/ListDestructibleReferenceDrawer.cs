...
[CustomPropertyDrawer(typeof(ListDestructibleReference))]
public class ListDestructibleReferenceDrawer : BaseReferenceDrawer {
    ...
    protected override void CreateFields(int type, Rect position, SerializedProperty property, float boolSize) {
        ...
        if(type == (int)ListDestructibleReference.VariableType.Constant) {
